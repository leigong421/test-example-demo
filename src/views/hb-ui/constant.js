 ...
 * @LastEditTime: 2022-09-27 11:25:52
...
export const colConfig = [
    {
        ...
        dragLocked: false,
        attrs: { label: '序号', prop: 'serial', align: 'left', width: '50', 'show-overflow-tooltip': false },
        slot: 'serial'
    },
    {
        switch: true,
        ...
        switchDisabled: false,
        dragLocked: false,
        attrs: { label: '厂区名称', prop: 'belongOfCompanyName', align: 'left', width: '', 'show-overflow-tooltip': false }
    },
    {
        switch: true,
        ...
        attrs: { label: '车间名称', prop: 'responsibleUnitName', align: 'left', width: '', 'show-overflow-tooltip': false }
    },
    {
        switch: true,
        ...
        switchDisabled: false,
        dragLocked: false,
        attrs: { label: '完成产值(元)', prop: 'completedOutputAndValue', align: 'left', width: '', 'show-overflow-tooltip': false }
    },
    {
        switch: true,
        ...
        switchDisabled: false,
        dragLocked: false,
        attrs: { label: '发生工费(元)', prop: 'workOrderCostOfGenerated', align: 'left', width: '', 'show-overflow-tooltip': false }
    },
    {
        switch: true,
        ...
        switchDisabled: false,
        dragLocked: false,
        attrs: { label: '管理费(元)', prop: 'boardCostOfGenerated', align: 'left', width: '', 'show-overflow-tooltip': false }
    },
    { switch: true, searchKey: 'diff', switchDisabled: false, dragLocked: false, attrs: { label: '产值差额(元)', prop: 'diff', align: 'left', width: '', 'show-overflow-tooltip': false } },
    { slotHeaderName: 'hbSetting', switch: true, attrs: { label: '', width: '100px', fixed: 'right' } }
];
